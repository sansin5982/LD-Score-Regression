...
* GWAS basics (summary statistics, effect sizes, standard errors, p-values)
...
* Using LDSC with stratified analyses (by tissue, cell type, functional category)
* Meta-analysis and combining multiple GWAS datasets
* Integration with FUMA, MAGMA, or other post-GWAS tools
* Interpretation of LDSC outputs (chi-square inflation, intercept, ratio)
